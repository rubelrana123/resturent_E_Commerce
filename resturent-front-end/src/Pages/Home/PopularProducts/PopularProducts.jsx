...
const popularFoods = [
  ...
  { id: 3, name: "Ruti With Chicken", img: foodImg2, oldPrice: 29, discountPercentence: 10 },
  { id: 4, name: "Fast Food Combo", img: foodImg3, oldPrice: 30, discountPercentence: 13 },
  { id: 5, name: "Chicago Deep Pizza", img: foodImg1, oldPrice: 28, discountPercentence: 27 },
  { id: 6, name: "Chinese Pasta", img: foodImg7, oldPrice: 40, discountPercentence: 15 },
  { id: 7, name: "Whopper Burger King", img: foodImg6, oldPrice: 30, discountPercentence: 13 },
  { id: 8, name: "Ruti With Beef Slice", img: foodImg2, oldPrice: 33, discountPercentence: 7 },
];
